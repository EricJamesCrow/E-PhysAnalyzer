...
class EphysAnalyzer(object):
    def __init__(self):
        ...
        QtGui.QFontDatabase.addApplicationFont("GILC____.ttf")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.fileSelectedLabel.setText(
            _translate("MainWindow", "<html><head/><body><p><span style=\" color:#ff0000;\"></span></p></body></html>"))
    ...
    def evenMoreVariables(self):
        ...
        self.copyrightLabel.setText(
            _translate("MainWindow", "Copyright (c) 2022 Cameron Cordero / Copyright (c) 2022 Eric Crow"))
    ...
    def run(self, files, drugAdded, whenDrug, excludedTraces, colorCode, colorCodes):
        ...
        for i in range(len(files)):
            ...
            mP.mkdir(files[i])
            mP.analyze_data(files[i], drugAdded[i], int(whenDrug[i]), self.excludedTracesStripped, colorCode,
                            colorCodes)
...
class ColorSelectionWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.crText.setText(_translate("MainWindow",
