class GrabSettings {
    ...
    returnData(){
        ...
        backend.run_analyze_data(fileData, score, remove, time, content.regions, defaultcolor, dpi, colorSelected, axisLimits, single, settings.outputFormat, settings.customDirectory, settings.mtkDefaultOutputPath)
    }
}
